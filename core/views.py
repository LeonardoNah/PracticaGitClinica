...
def carga_medico(request):
    context={
        'nombre_medico': 'Carlos Lopez',
        'hora': datetime.now,
        'especialidad': 'Clinico',
    }
    return render ( request, 'core/carga_medico.html',context )
